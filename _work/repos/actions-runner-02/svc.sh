...
SVC_NAME="actions.runner.FlexNetOS.fxrun-drdave-TRX50-AI-TOP-flexnetos-02.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (FlexNetOS.fxrun-drdave-TRX50-AI-TOP-flexnetos-02)"
